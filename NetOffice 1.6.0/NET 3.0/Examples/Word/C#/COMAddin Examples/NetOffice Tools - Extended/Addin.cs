...
namespace NetOfficeTools.ExtendedWordCS3
{
    /*
    ...
    */
    ...
    [CustomUI("NetOfficeTools.ExtendedWordCS3.RibbonUI.xml")]     // you can specify a path to an embedded xml ressource file with your ribbon schema, otherwise you can override the GetCustomUI method from COMAddin base class
    [GuidAttribute("A37BAA2D-21CC-42DC-9AC8-F6101D6DF1AE"), ProgId("ExtendedWordCS3.Addin")]
    public class Addin : COMAddin
    {
        ...
        public void OnAction(NetOffice.OfficeApi.IRibbonControl control)
        {
            try
            {
                ...
                {
                    case "customButton1":
                        MessageBox.Show("This is the first sample button.", "ExtendedWordCS3.Addin");
                        break;
                    case "customButton2":
                        MessageBox.Show("This is the second sample button.", "ExtendedWordCS3.Addin");
                        break;
                    default:
                        MessageBox.Show("Unkown Control Id: " + control.Id, "ExtendedWordCS3.Addinn");
                        break;
                }
            }
        ...
        */
        ...
        {
            MessageBox.Show("An error occurend in " + methodKind.ToString(), "ExtendedWordCS3.Addin");
        }
