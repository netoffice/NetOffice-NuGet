...
<GuidAttribute("96B32EF6-9E59-4361-B5C2-BF59CEF0BCDD"), ProgIdAttribute("ExcelAddinVB3.RibbonAddin"), ComVisible(True)> _
Public Class Addin
    ...
    Private Shared ReadOnly _progId As String = "ExcelAddinVB3.RibbonAddin"
