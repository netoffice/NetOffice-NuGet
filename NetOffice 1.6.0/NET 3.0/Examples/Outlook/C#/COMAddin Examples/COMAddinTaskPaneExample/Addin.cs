...
namespace COMAddinTaskPaneExampleCS3
{
    [GuidAttribute("9516CD2B-9421-4F26-9181-1A646DDC8C35"), ProgId("OutlookAddinCS3.TaskPaneAddin"), ComVisible(true)]
    public class Addin : IDTExtensibility2 , Office.ICustomTaskPaneConsumer
    {
        ...
        private static readonly string _prodId                  = "OutlookAddinCS3.TaskPaneAddin";
        ...
        public void CTPFactoryAvailable(object CTPFactoryInst)
        {
            try
            {
                ...
                Office._CustomTaskPane taskPane = ctpFactory.CreateCTP(typeof(Addin).Assembly.GetName().Name + ".SampleControl", "NetOffice Sample Pane(CS3)", Type.Missing);
