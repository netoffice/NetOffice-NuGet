...
{
    [GuidAttribute("B1EF4706-D318-4BE9-93FA-7C57D3A3C6F0"), ProgId("PPointAddinCS3.RibbonAddin"), ComVisible(true)]
    public class Addin : IDTExtensibility2, Office.IRibbonExtensibility
    {
        ...
        private static readonly string _progId                  = "PPointAddinCS3.RibbonAddin";
