...
namespace COMAddinClassicExampleCS3
{
    [GuidAttribute("629BC55C-7C01-4065-932A-4BB88F7B8C59"), ProgId("PPointAddinCS3.SimpleAddin"), ComVisible(true)]
    public class Addin : IDTExtensibility2
    {
        ...
        private static readonly string _progId                  = "PPointAddinCS3.SimpleAddin";
        ...
        // gui elements
        private static readonly string _toolbarName             = "Sample Toolbar CS3";
        private static readonly string _toolbarButtonName       = "Sample ToolbarButton CS3";
        private static readonly string _toolbarPopupName        = "Sample ToolbarPopup CS3";
        private static readonly string _menuName                = "Sample Menu CS3";
        private static readonly string _menuButtonName          = "Sample Button CS3";
        private static readonly string _contextName             = "Sample ContextMenu CS3";
        private static readonly string _contextMenuButtonName   = "Sample ContextButton CS3";
