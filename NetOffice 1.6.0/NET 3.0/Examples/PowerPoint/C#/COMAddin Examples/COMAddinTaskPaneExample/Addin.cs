...
{
    [GuidAttribute("40C8F944-BD8D-41D7-8314-2C99343F148C"), ProgId("PPointAddinCS3.TaskPaneAddin"), ComVisible(true)]
    public class Addin : IDTExtensibility2, Office.ICustomTaskPaneConsumer
    {
        ...
        private static readonly string _progId                  = "PPointAddinCS3.TaskPaneAddin";
