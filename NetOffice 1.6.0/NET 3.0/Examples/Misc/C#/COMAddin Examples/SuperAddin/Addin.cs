...
{ 
    ...
    /// the addin class
    /// </summary>
    [GuidAttribute("39AA1CDE-F186-456B-ADF6-30D03352C131"), ProgId("SuperAddinCS3.Addin"), ComVisible(true)]
    public class Addin : IDTExtensibility2, Office.IRibbonExtensibility
    {
        private static readonly string _progId                  = "SuperAddinCS3.Addin";
