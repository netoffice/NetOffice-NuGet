...
<COMAddin("NetOfficeVB3 Extended Access Addin", "This Addin shows you the COMAddin  baseclass from the NetOffice Tools", 3)> _
<RegistryLocation(RegistrySaveLocation.CurrentUser)> _
<CustomUI("NetOfficeTools.ExtendedAccessVB3.RibbonUI.xml")> _
<GuidAttribute("C5ED5AD1-D1C2-45b8-B836-0F3D966D063F"), ProgIdAttribute("ExtendedAccessVB3.Addin")> _
Public Class Addin
    Inherits COMAddin
    ...
    Public Sub OnAction(ByVal control As Office.IRibbonControl)
        Try
            ...
            Select Case control.Id
                Case "customButton1"
                    MessageBox.Show("This is the first sample button.", "ExtendedAccessVB3.Addin")
                Case "customButton2"
                    MessageBox.Show("This is the second sample button.", "ExtendedAccessVB3.Addin")
                Case Else
                    MessageBox.Show("Unkown Control Id: " + control.Id, "ExtendedAccessVB3.Addin")
