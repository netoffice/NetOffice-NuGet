...
namespace COMAddinClassicExampleCS2
{
    [GuidAttribute("629BC55C-7C01-4065-932A-4BB88F7B8C59"), ProgId("PPointAddinCS2.SimpleAddin"), ComVisible(true)]
    public class Addin : IDTExtensibility2
    {
        ...
        private static readonly string _progId                  = "PPointAddinCS2.SimpleAddin";
        ...
        // gui elements
        private static readonly string _toolbarName             = "Sample Toolbar CS2";
        private static readonly string _toolbarButtonName       = "Sample ToolbarButton CS2";
        private static readonly string _toolbarPopupName        = "Sample ToolbarPopup CS2";
        private static readonly string _menuName                = "Sample Menu CS2";
        private static readonly string _menuButtonName          = "Sample Button CS2";
        private static readonly string _contextName             = "Sample ContextMenu CS2";
        private static readonly string _contextMenuButtonName   = "Sample ContextButton CS2";
