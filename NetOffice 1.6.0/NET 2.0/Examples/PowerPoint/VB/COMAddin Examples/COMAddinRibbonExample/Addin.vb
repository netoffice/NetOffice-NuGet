...
<GuidAttribute("0737A154-B18D-4328-8DAC-B7B8EECAB032"), ProgIdAttribute("PPointAddinVB2.RibbonAddin"), ComVisible(True)> _
Public Class Addin
    ...
    Private Shared ReadOnly _progId As String = "PPointAddinVB2.RibbonAddin"
