...
<COMAddin("NetOfficeVB2 Extended PowerPoint Addin", "This Addin shows you the COMAddin  baseclass from the NetOffice Tools", 3)> _
<RegistryLocation(RegistrySaveLocation.CurrentUser)> _
<CustomUI("NetOfficeTools.ExtendedPPointVB2.RibbonUI.xml")> _
<GuidAttribute("B0A0F2A7-FD40-47B6-A419-28D0A9AA0E1F"), ProgIdAttribute("ExtendedPPointVB2.Addin")> _
Public Class Addin
    Inherits COMAddin
    ...
    Public Sub OnAction(ByVal control As Office.IRibbonControl)
        Try
            ...
            Select Case control.Id
                Case "customButton1"
                    MessageBox.Show("This is the first sample button.", "ExtendedPPointVB2.Addin")
                Case "customButton2"
                    MessageBox.Show("This is the second sample button.", "ExtendedPPointVB2.Addin")
                Case Else
                    MessageBox.Show("Unkown Control Id: " + control.Id, "ExtendedPPointVB2.Addin")
        ...
        Catch throwedException As Exception
            ...
            MessageBox.Show("An error occured in OnAction." + details, "ExtendedAccessVB2.Addin", MessageBoxButtons.OK, MessageBoxIcon.Error)
