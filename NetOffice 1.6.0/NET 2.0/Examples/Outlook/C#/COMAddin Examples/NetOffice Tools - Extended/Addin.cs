...
namespace NetOfficeTools.ExtendedOutlookCS2
{
    /*
     * as you can see, the needed registry informations was given as annotation, no need for Register/Unregister methods
    */
    [COMAddin("NetOfficeCS2 Extended Sample Addin", "This Addin shows you the COMAddin class from the NetOffice Tools", 3)]
    ...
    [CustomUI("NetOfficeTools.ExtendedOutlookCS2.RibbonUI.xml")]    // you can specify a path to an embedded xml ressource file with your ribbon schema, otherwise you can override the GetCustomUI method from COMAddin base class
    [GuidAttribute("B3F60319-1A11-4F3E-9C1B-3AE908D9CA86"), ProgId("ExtendedOutlookCS2.Addin")]
    public class Addin : COMAddin
    {
        ...
        public void OnAction(NetOffice.OfficeApi.IRibbonControl control)
        {
            try
            {
                ...
                {
                    case "customButton1":
                        MessageBox.Show("This is the first sample button.", "ExtendedOutlookCS2.Addin");
                        break;
                    case "customButton2":
                        MessageBox.Show("This is the second sample button.", "ExtendedOutlookCS2.Addin");
                        break;
                    default:
                        MessageBox.Show("Unkown Control Id: " + control.Id, "ExtendedOutlookCS2.Addin");
                        break;
                }
            }
        ...
        */
        ...
        {
            MessageBox.Show("An error occurend in " + methodKind.ToString(), "ExtendedOutlookCS2.Addin");
        }
