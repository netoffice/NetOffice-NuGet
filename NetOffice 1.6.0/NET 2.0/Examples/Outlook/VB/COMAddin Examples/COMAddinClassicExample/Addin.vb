...
<GuidAttribute("224A9335-4C97-4F5C-A15C-1A5B9EB39225"), ProgIdAttribute("OutlookAddinVB2.SimpleAddin"), ComVisible(True)> _
Public Class Addin
    Implements IDTExtensibility2

    Private Shared ReadOnly _addinOfficeRegistryKey As String = "Software\\Microsoft\\Office\\Outlook\\AddIns\\"
    Private Shared ReadOnly _progId As String = "OutlookAddinVB2.SimpleAddin"
