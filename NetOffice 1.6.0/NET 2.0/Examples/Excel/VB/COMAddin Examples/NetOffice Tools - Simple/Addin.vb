...
<COMAddin("NetOfficeVB2 Sample Excel Addin", "This Addin shows you the COMAddin base class from the NetOffice Tools", 3)> _
<GuidAttribute("B5CBBECD-4DEE-4A61-AD34-E9B8618452B0"), ProgIdAttribute("SimpleExcelVB2.Addin")> _
Public Class Addin
    Inherits COMAddin
