...
<COMAddin("NetOfficeVB2 Extended Word Addin", "This Addin shows you the COMAddin  baseclass from the NetOffice Tools", 3)> _
<RegistryLocation(RegistrySaveLocation.CurrentUser)> _
<CustomUI("NetOfficeTools.ExtendedWordVB2.RibbonUI.xml")> _
<GuidAttribute("A7F57B00-924A-4C61-BFCD-7F1620645A65"), ProgIdAttribute("ExtendedWordVB2.Addin")> _
Public Class Addin
    Inherits COMAddin
    ...
    Public Sub OnAction(ByVal control As Office.IRibbonControl)
        Try
            ...
            Select Case control.Id
                Case "customButton1"
                    MessageBox.Show("This is the first sample button.", "ExtendedWordVB2.Addin")
                Case "customButton2"
                    MessageBox.Show("This is the second sample button.", "ExtendedWordVB2.Addin")
                Case Else
                    MessageBox.Show("Unkown Control Id: " + control.Id, "ExtendedWordVB2.Addin")
