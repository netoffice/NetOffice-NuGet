...
<GuidAttribute("E21D8B00-76BF-473B-8617-2E640CCF00C4"), ProgIdAttribute("WordAddinVB2.TaskPaneAddin"), ComVisible(True)> _
Public Class Addin
    ...
    Private Shared ReadOnly _prodId As String = "WordAddinVB2.TaskPaneAddin"
