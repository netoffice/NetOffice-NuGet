...
<GuidAttribute("8430EA50-AE45-40A2-8122-F528ED8E032C"), ProgIdAttribute("AccessAddinVB2.RibbonAddin"), ComVisible(True)> _
Public Class Addin
    ...
    Private Shared ReadOnly _progId As String = "AccessAddinVB2.RibbonAddin"
