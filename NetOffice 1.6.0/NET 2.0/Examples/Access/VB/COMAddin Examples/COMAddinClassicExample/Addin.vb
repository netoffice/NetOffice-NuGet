...
<GuidAttribute("A48F84DF-BD64-4A8F-95B0-452989733AE2"), ProgIdAttribute("AccessAddinVB2.SimpleAddin"), ComVisible(True)> _
Public Class Addin
    Implements IDTExtensibility2

    Private Shared ReadOnly _addinOfficeRegistryKey As String = "Software\\Microsoft\\Office\\Access\\AddIns\\"
    Private Shared ReadOnly _progId As String = "AccessAddinVB2.SimpleAddin"
