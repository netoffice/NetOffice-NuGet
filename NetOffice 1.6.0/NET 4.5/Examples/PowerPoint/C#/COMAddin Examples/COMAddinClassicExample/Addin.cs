...
namespace COMAddinClassicExampleCS45
{
    [GuidAttribute("629BC55C-7C01-4065-932A-4BB88F7B8C59"), ProgId("PPointAddinCS45.SimpleAddin"), ComVisible(true)]
    public class Addin : IDTExtensibility2
    {
        ...
        private static readonly string _progId                  = "PPointAddinCS45.SimpleAddin";
        ...
        // gui elements
        private static readonly string _toolbarName             = "Sample Toolbar CS45";
        private static readonly string _toolbarButtonName       = "Sample ToolbarButton CS45";
        private static readonly string _toolbarPopupName        = "Sample ToolbarPopup CS45";
        private static readonly string _menuName                = "Sample Menu CS45";
        private static readonly string _menuButtonName          = "Sample Button CS45";
        private static readonly string _contextName             = "Sample ContextMenu CS45";
        private static readonly string _contextMenuButtonName   = "Sample ContextButton CS45";
