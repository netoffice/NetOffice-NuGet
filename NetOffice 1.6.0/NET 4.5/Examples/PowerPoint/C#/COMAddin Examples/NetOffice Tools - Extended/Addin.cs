...
namespace NetOfficeTools.ExtendedPPointCS45
{
    ...
    */
    ...
    [CustomUI("NetOfficeTools.ExtendedPPointCS45.RibbonUI.xml")]     // you can specify a path to an embedded xml ressource file with your ribbon schema, otherwise you can override the GetCustomUI method from COMAddin base class
    [GuidAttribute("ECC3C2C8-18F4-4D37-8B31-5FFC12FF9A6E"), ProgId("ExtendedPPointCS45.Addin")]
    public class Addin : COMAddin
    {
        ...
        public void OnAction(NetOffice.OfficeApi.IRibbonControl control)
        {
            try
            {
                ...
                {
                    case "customButton1":
                        MessageBox.Show("This is the first sample button.", "ExtendedPPointCS45.Addin");
                        break;
                    case "customButton2":
                        MessageBox.Show("This is the second sample button.", "ExtendedPPointCS45.Addin");
                        break;
                    default:
                        MessageBox.Show("Unkown Control Id: " + control.Id, "ExtendedPPointCS45.Addin");
                        break;
                }
            }
        ...
        */
        ...
        {
            MessageBox.Show("An error occurend in " + methodKind.ToString(), "ExtendedPPointCS45.Addin");
        }
