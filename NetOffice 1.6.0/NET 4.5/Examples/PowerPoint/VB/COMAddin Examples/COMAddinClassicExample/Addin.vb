...
<GuidAttribute("C994BD16-0CD3-4058-8BF4-B91A3D2975F9"), ProgIdAttribute("PPointAddinVB45.SimpleAddin"), ComVisible(True)> _
Public Class Addin
    Implements IDTExtensibility2

    Private Shared ReadOnly _addinOfficeRegistryKey As String = "Software\\Microsoft\\Office\\PowerPoint\\AddIns\\"
    Private Shared ReadOnly _progId As String = "PPointAddinVB45.SimpleAddin"
    ...
    ' gui elements
    Private Shared ReadOnly _toolbarName = "Sample Toolbar VB45"
    Private Shared ReadOnly _toolbarButtonName As String = "Sample ToolbarButton VB45"
    Private Shared ReadOnly _toolbarPopupName As String = "Sample ToolbarPopup VB45"
    Private Shared ReadOnly _menuName As String = "Sample Menu VB45"
    Private Shared ReadOnly _menuButtonName As String = "Sample Button VB45"
    Private Shared ReadOnly _contextName As String = "Sample ContextMenu VB45"
    Private Shared ReadOnly _contextMenuButtonName As String = "Sample ContextButton VB45"
