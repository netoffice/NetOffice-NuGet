...
namespace COMAddinRibbonExampleCS45
{
    [GuidAttribute("44665894-708B-45B2-B2D8-6D2C8D2CA0A6"), ProgId("AccessAddinCS45.RibbonAddin"), ComVisible(true)]
    public class Addin : IDTExtensibility2, Office.IRibbonExtensibility
    {
        ...
        private static readonly string _progId                  = "AccessAddinCS45.RibbonAddin";
