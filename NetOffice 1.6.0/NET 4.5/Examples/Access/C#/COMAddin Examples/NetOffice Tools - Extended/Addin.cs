...
namespace NetOfficeTools.ExtendedAccessCS45
{
    /*
     * as you can see, the needed registry informations was given as annotation, no need for Register/Unregister methods
    */
    [COMAddin("NetOfficeCS45 Extended Sample Addin", "This Addin shows you the COMAddin class from the NetOffice Tools", 3)]
    ...
    [CustomUI("NetOfficeTools.ExtendedAccessCS45.RibbonUI.xml")]     // you can specify a path to an embedded xml ressource file with your ribbon schema, otherwise you can override the GetCustomUI method from COMAddin base class
    [GuidAttribute("C5ED5AD1-D1C2-45b8-B836-0F3D966D063F"), ProgId("ExtendedAccessCS45.Addin")]  
    public class Addin : COMAddin
    {
        ...
        public void OnAction(NetOffice.OfficeApi.IRibbonControl control)
        {
            try
            {
                ...
                {
                    case "customButton1":
                        MessageBox.Show("This is the first sample button.", "ExtendedAccessCS45.Addin");
                        break;
                    case "customButton2":
                        MessageBox.Show("This is the second sample button.", "ExtendedAccessCS45.Addin");
                        break;
                    default:
                        MessageBox.Show("Unkown Control Id: " + control.Id, "ExtendedAccessCS45.Addinn");
                        break;
                }
            }
        ...
        */
        ...
        {
            MessageBox.Show("An error occurend in " + methodKind.ToString(), "COMAddinNetOfficeToolsExCS45.AccessSampleAddin");
        }
