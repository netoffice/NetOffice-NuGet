...
<COMAddin("NetOfficeVB45 Extended Access Addin", "This Addin shows you the COMAddin  baseclass from the NetOffice Tools", 3)> _
<RegistryLocation(RegistrySaveLocation.CurrentUser)> _
<CustomUI("NetOfficeTools.ExtendedAccessVB45.RibbonUI.xml")> _
<GuidAttribute("C5ED5AD1-D1C2-45b8-B836-0F3D966D063F"), ProgIdAttribute("ExtendedAccessVB45.Addin")> _
Public Class Addin
    Inherits COMAddin
    ...
    Public Sub OnAction(ByVal control As Office.IRibbonControl)
        Try
            ...
            Select Case control.Id
                Case "customButton1"
                    MessageBox.Show("This is the first sample button.", "ExtendedAccessVB45.Addin")
                Case "customButton2"
                    MessageBox.Show("This is the second sample button.", "ExtendedAccessVB45.Addin")
                Case Else
                    MessageBox.Show("Unkown Control Id: " + control.Id, "ExtendedAccessVB45.Addin")
