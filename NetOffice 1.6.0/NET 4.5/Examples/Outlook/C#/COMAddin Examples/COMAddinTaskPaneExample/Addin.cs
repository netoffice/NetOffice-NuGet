...
namespace COMAddinTaskPaneExampleCS45
{
    [GuidAttribute("9516CD2B-9421-4F26-9181-1A646DDC8C35"), ProgId("OutlookAddinCS45.TaskPaneAddin"), ComVisible(true)]
    public class Addin : IDTExtensibility2 , Office.ICustomTaskPaneConsumer
    {
        ...
        private static readonly string _prodId                  = "OutlookAddinCS45.TaskPaneAddin";
        ...
        public void CTPFactoryAvailable(object CTPFactoryInst)
        {
            try
            {
                ...
                Office._CustomTaskPane taskPane = ctpFactory.CreateCTP(typeof(Addin).Assembly.GetName().Name + ".SampleControl", "NetOffice Sample Pane(CS45)", Type.Missing);
