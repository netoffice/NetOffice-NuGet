...
<GuidAttribute("185F1857-97D9-45E3-9D1F-2180F942A4AB"), ProgIdAttribute("OutlookAddinVB45.TaskPaneAddin"), ComVisible(True)> _
Public Class Addin
    ...
    Private Shared ReadOnly _prodId As String = "OutlookAddinVB45.TaskPaneAddin"
...
#Region "ICustomTaskPaneConsumer Member"
    ...
    Public Sub CTPFactoryAvailable(ByVal CTPFactoryInst As Object) Implements NetOffice.OfficeApi.ICustomTaskPaneConsumer.CTPFactoryAvailable
        ...
        Try
            ...
            Dim taskPane As Office._CustomTaskPane = ctpFactory.CreateCTP(GetType(Addin).Assembly.GetName().Name + ".SampleControl", "NetOffice Sample Pane(VB45)", Type.Missing)
