...
<COMAddin("NetOfficeVB45 Extended Outlook Addin", "This Addin shows you the COMAddin  baseclass from the NetOffice Tools", 3)> _
<RegistryLocation(RegistrySaveLocation.CurrentUser)> _
<CustomUI("NetOfficeTools.ExtendedOutlookVB45.RibbonUI.xml")> _
<GuidAttribute("DB89E4AD-6B44-4EFF-A9B5-174335D98A16"), ProgIdAttribute("ExtendedOutlookVB45.Addin")> _
Public Class Addin
    Inherits COMAddin
    ...
    Public Sub OnAction(ByVal control As Office.IRibbonControl)
        Try
            ...
            Select Case control.Id
                Case "customButton1"
                    MessageBox.Show("This is the first sample button.", "ExtendedOutlookVB45.Addin")
                Case "customButton2"
                    MessageBox.Show("This is the second sample button.", "ExtendedOutlookVB45.Addin")
                Case Else
                    MessageBox.Show("Unkown Control Id: " + control.Id, "ExtendedOutlookVB45.Addin")
        ...
        Catch throwedException As Exception
            ...
            MessageBox.Show("An error occured in OnAction." + details, "ExtendedOutlookVB45.Addin", MessageBoxButtons.OK, MessageBoxIcon.Error)
