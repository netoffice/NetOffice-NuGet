...
namespace NetOfficeTools.ExtendedPPointCS35
{
    /*
    ...
    */
    ...
    [CustomUI("NetOfficeTools.ExtendedPPointCS35.RibbonUI.xml")]     // you can specify a path to an embedded xml ressource file with your ribbon schema, otherwise you can override the GetCustomUI method from COMAddin base class
    [GuidAttribute("ECC3C2C8-18F4-4D37-8B31-5FFC12FF9A6E"), ProgId("ExtendedPPointCS35.Addin")]
    public class Addin : COMAddin
    {
        ...
        public void OnAction(NetOffice.OfficeApi.IRibbonControl control)
        {
            try
            {
                ...
                {
                    case "customButton1":
                        MessageBox.Show("This is the first sample button.", "ExtendedPPointCS35.Addin");
                        break;
                    case "customButton2":
                        MessageBox.Show("This is the second sample button.", "ExtendedPPointCS35.Addin");
                        break;
                    default:
                        MessageBox.Show("Unkown Control Id: " + control.Id, "ExtendedPPointCS35.Addin");
                        break;
                }
            }
        ...
        */
        ...
        {
            MessageBox.Show("An error occurend in " + methodKind.ToString(), "ExtendedPPointCS35.Addin");
        }
