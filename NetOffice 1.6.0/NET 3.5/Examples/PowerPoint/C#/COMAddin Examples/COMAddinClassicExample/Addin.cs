...
namespace COMAddinClassicExampleCS35
{
    [GuidAttribute("629BC55C-7C01-4065-932A-4BB88F7B8C59"), ProgId("PPointAddinCS35.SimpleAddin"), ComVisible(true)]
    public class Addin : IDTExtensibility2
    {
        ...
        private static readonly string _progId                  = "PPointAddinCS35.SimpleAddin";
        ...
        // gui elements
        private static readonly string _toolbarName             = "Sample Toolbar CS35";
        private static readonly string _toolbarButtonName       = "Sample ToolbarButton CS35";
        private static readonly string _toolbarPopupName        = "Sample ToolbarPopup CS35";
        private static readonly string _menuName                = "Sample Menu CS35";
        private static readonly string _menuButtonName          = "Sample Button CS35";
        private static readonly string _contextName             = "Sample ContextMenu CS35";
        private static readonly string _contextMenuButtonName   = "Sample ContextButton CS35";
