...
<COMAddin("NetOfficeVB35 Sample PowerPoint Addin", "This Addin shows you the COMAddin base class from the NetOffice Tools", 3)> _
<GuidAttribute("F8E32638-8BC0-4A0D-82B5-1B1478FB41D2"), ProgIdAttribute("SimplePPointVB35.Addin")> _
Public Class Addin
    Inherits COMAddin
