...
<COMAddin("NetOfficeVB35 Extended Excel Addin", "This Addin shows you the COMAddin  baseclass from the NetOffice Tools", 3)> _
<RegistryLocation(RegistrySaveLocation.CurrentUser)> _
<CustomUI("NetOfficeTools.ExtendedExcelVB35.RibbonUI.xml")> _
<GuidAttribute("ED20A119-9E0D-4D7B-B50A-71CFFD44A7C7"), ProgIdAttribute("ExtendedExcelVB35.Addin")> _
Public Class Addin
    Inherits COMAddin
    ...
    Public Sub OnAction(ByVal control As Office.IRibbonControl)
        Try
            ...
            Select Case control.Id
                Case "customButton1"
                    MessageBox.Show("This is the first sample button.", "ExtendedExcelVB35.Addin")
                Case "customButton2"
                    MessageBox.Show("This is the second sample button.", "ExtendedExcelVB35.Addin")
                Case Else
                    MessageBox.Show("Unkown Control Id: " + control.Id, "ExtendedExcelVB35.Addin")
        ...
        Catch throwedException As Exception
            ...
            MessageBox.Show("An error occured in OnAction." + details, "ExtendedExcelVB35.Addin", MessageBoxButtons.OK, MessageBoxIcon.Error)
