...
namespace NetOfficeTools.ExtendedExcelCS35
{
    /*
    ...
    */
    ...
    [CustomUI("NetOfficeTools.ExtendedExcelCS35.RibbonUI.xml")]     // you can specify a path to an embedded xml ressource file with your ribbon schema, otherwise you can override the GetCustomUI method from COMAddin base class
    [GuidAttribute("BA38FD48-47BD-43de-8177-0D067A01B566"), ProgId("ExtendedExcelCS35.Addin")]
    public class Addin : COMAddin
    {
        ...
        public void OnAction(NetOffice.OfficeApi.IRibbonControl control)
        {
            try
            {
                ...
                {
                    case "customButton1":
                        MessageBox.Show("This is the first sample button.", "ExtendedExcelCS35.Addin");
                        break;
                    case "customButton2":
                        MessageBox.Show("This is the second sample button.", "ExtendedExcelCS35.Addin");
                        break;
                    default:
                        MessageBox.Show("Unkown Control Id: " + control.Id, "ExtendedExcelCS35.Addin");
                        break;
                }
            }
        ...
        */
        ...
        {
            MessageBox.Show("An error occurend in " + methodKind.ToString(), "ExtendedExcelCS35.Addin");
        }
