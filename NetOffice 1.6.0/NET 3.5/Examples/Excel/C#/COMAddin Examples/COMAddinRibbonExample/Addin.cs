...
{
    [GuidAttribute("32883BAD-012A-4B48-A972-3F918C2D54CD"), ProgId("ExcelAddinCS35.RibbonAddin"), ComVisible(true)]
    public class Addin : IDTExtensibility2, Office.IRibbonExtensibility
    {
        ...
        private static readonly string _progId                  = "ExcelAddinCS35.RibbonAddin";
