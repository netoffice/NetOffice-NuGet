...
{
    [GuidAttribute("A8BCC763-BC69-49DA-8DBF-C8DE353B745D"), ProgId("WordAddinCS35.TaskPaneAddin"), ComVisible(true)]
    public class Addin : IDTExtensibility2, Office.ICustomTaskPaneConsumer
    {
        ...
        private static readonly string _prodId                  = "WordAddinCS35.TaskPaneAddin";
