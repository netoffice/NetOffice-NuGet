...
namespace COMAddinTaskPaneExampleCS35
{
    [GuidAttribute("9516CD2B-9421-4F26-9181-1A646DDC8C35"), ProgId("OutlookAddinCS35.TaskPaneAddin"), ComVisible(true)]
    public class Addin : IDTExtensibility2 , Office.ICustomTaskPaneConsumer
    {
        ...
        private static readonly string _prodId                  = "OutlookAddinCS35.TaskPaneAddin";
